...
function NewsPage() {
  ...
  useEffect(() => {
    const fetchNews = async () => {
      try {
        ...
        } else if(data.messages==='News not found'){setIdNotFound(true)} else {
  ...
  return (
    <>
    <motion.div id="scroll-indicator" style={{scaleX:scrollYProgress||0,originX:0}} className="fixed top-0 left-0 right-0 h-1 bg-gradient-to-r from-pink-400 to-pink-700 dark:from-blue-400 dark:to-blue-700"></motion.div>
