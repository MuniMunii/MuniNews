...
function NavbarAdmin(){
    ...
    return (
                    <div className={`w-96 h-full border-r  p-4 flex flex-col items-center justify-between font-Poppins bg-white border-gray-600 dark:bg-darkTheme text-black`}>
                        ...
                        <Link to={'news'} className={`py-1 px-3 font-semibold text-black/50 hover:text-black dark:text-white/40 dark:hover:text-white transition duration-300 select-none cursor-pointer rounded-md flex items-center gap-2`}><HiOutlinePencilAlt/>News</Link>
                        </div>
