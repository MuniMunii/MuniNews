...
function IndexScreen(){
    ...
    return (
        <div className={`dotted w-screen text-black min-h-screen  relative flex items-center justify-between p-8 ${isLight?' border-y border-b-black/50 border-t-black/50 bg-white':'border-y border-b-white border-t-white bg-darkTheme'}`}>
        ...
        <motion.a whileHover={{scale:1.1}} whileTap={{scale:0.8}} href="#news" className={`py-2 px-14 my-6 w-fit text-black rounded-md font-semibold font-sans ${isLight?'bg-oceanBlue text-white':'bg-pink-500'}`}>Start Reading</motion.a>
